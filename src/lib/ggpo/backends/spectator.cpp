...
//    _udp.Init(localport, &_poll, this);
   ...
   */
   ...
   // _host.Init(&_udp, _poll, 0, hostip, hostport, NULL);
      /*
    * Init the host endpoint, steam version. Looked at p2p.cpp:94
    */
   _host.Init(&_steam, host_id, _poll, 0, NULL);
...
SpectatorBackend::OnSteamProtocolEvent(SteamProtocol::Event &evt)
{
   GGPOEvent info;
